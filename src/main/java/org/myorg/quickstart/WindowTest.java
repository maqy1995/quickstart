...
public class WindowTest {
    ...
    public static final class filterNum implements FilterFunction<Tuple2<String, Integer>>{
        @Override
        public boolean filter(Tuple2<String,Integer> stringIntegerTuple2) throws Exception{
            if(stringIntegerTuple2.getField(0).equals("ma")){
                return true;
    ...
    public static final class ToInteger implements MapFunction<String,Tuple2<Integer,Integer>>{
        @Override
        public Tuple2<Integer,Integer> map(String value) throws Exception{

            return new Tuple2<Integer, Integer>(num,Integer.parseInt(value));
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream <Tuple2<Integer,Integer>> countsFilter=text.map(new ToInteger())
                .keyBy(0)
                //.filter(new filterMa())
