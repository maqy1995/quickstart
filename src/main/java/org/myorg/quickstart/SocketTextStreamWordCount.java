...
public class SocketTextStreamWordCount {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 4){
			System.err.println("USAGE:\nSocketTextStreamWordCount <hostname> <port> <outpath> <parallism>");
			return;
		}
		...
		int parallism = Integer.parseInt(args[3]);
		...
		DataStream<Tuple2<String, Integer>> b=a.flatMap(new LineSplitter());
		// group by the tuple field "0" and sum up tuple field "1"
//				.keyBy(0)
//				.sum(1);

		DataStream<Tuple2<String,Integer>> c = b.keyBy(0)
				.sum(1);

		c.writeAsText(output);
